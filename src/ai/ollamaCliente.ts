// Cliente mínimo contra la API local de Ollama (vía proxy Vite en /api/ollama).
// Offline: todo ocurre en localhost, sin Google Cloud ni claves.

export const OLLAMA_BASE = import.meta.env.VITE_OLLAMA_BASE ?? '/api/ollama';
export const OLLAMA_MODEL = import.meta.env.VITE_OLLAMA_MODEL ?? 'gemma4';
